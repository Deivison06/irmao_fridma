...
<body>
    ...
    <div>
        ...
        <p style="text-align: justify;">
            2.1 Para uma contratação mais segura e eficaz, sugerimos como técnica de averiguação,
            e controle, as seguintes exigências mínimas:
        </p>
        <p style="text-align: justify;">
            2.1.1. Os Serviços deverão ser executados de forma parcelada, de acordo com as
            solicitações da CONTRATANTE, por meio de suas respectivas OF.’s;
        </p>
        <p style="text-align: justify;">
            2.1.2. Os Serviços deverão ser iniciados em até 48 (quarenta e oito) horas contadas do
            envio do Pedido de Fornecimento/serviço Empenho, devendo a contratada manter
            estoques compatíveis com as quantidades solicitadas durante o prazo de vigência do
            contrato, evitando atrasos nas entregas/fornecimentos, sem a exigência de valor ou
            quantitativo mínimo e sem custos adicionais.
        </p>
        <p style="text-align: justify;">
            2.1.3. Os serviços deverão ser executados nas respectivas Unidades e locais de indicação
            do CONTRATANTE, em horários e datas previamente estabelecidas na respectiva Ordem
            de Serviço;
        </p>
        <p style="text-align: justify;">
            2.1.4 A nota fiscal deverá ser apresentada no ato da entrega informado o número do
            Contrato correspondente no campo “Dados Adicionais”.
        </p>
        <p style="text-align: justify;">
            2.1.6. A Contratada deverá arcar com as despesas de alimentação, deslocamento e
            demais despesas referentes às prestações dos serviços.
        </p>
        <p style="text-align: justify;">
            2.1.7. Serão exigidas comprovações de localização da sede da empresa, com
            apresentação de fotos da infraestrutura interna, com objetivo precípuo de averiguar a
            veracidade sobre a real existência da empresa, evitando a contratação de empresas
            fantasmas ou de caráter inidôneo.
        </p>
        <p style="text-align: justify;">
            2.1.8. Serão exigidas composições de custos que reflitam a realidade econômica da
            empresa licitante, a ser definido no próprio edital, que estabelecem critérios de custos com
            despesas diretas e indiretas;
        </p>
        <p style="text-align: justify;">
            2.1.9. Também será exigido garantia de proposta, nos termos do art. 96 e seguintes,
            visando estabelecer a segurança do preço ofertado pelo licitante, garantindo assim, o
            seguro do custeio realizado pela Administração no momento da abertura do certame;
        </p>
        <p style="text-align: justify;">
    ...
    <div>
        ...
        <p style="text-align: justify;">
            3.1. O prazo de início dos serviços é de 02 (dois) dias, contados da Ordem de Serviço, em remessa
            parcelada de acordo com a necessidade da Administração.
        </p>
        <p style="text-align: justify;">
            3.2. Caso não seja possível o início na data assinalada, a empresa deverá comunicar as razões
            respectivas com pelo menos (01) dias de antecedência para que qualquer pleito de prorrogação
            de prazo seja analisado, ressalvadas situações de caso fortuito e força maior.
        </p>
        <p style="text-align: justify;">
            3.3. Os serviços serão prestados na sede da Prefeitura Municipal ou em local indicado pela
            secretaria competente.
        </p>
        <p style="text-align: justify;">
            3.5. O prazo de garantia é aquele estabelecido na Lei nº 8.078, de 11 de setembro de 1990 (Código
    ...
    <div>
        ...
        <p style="text-align: justify;">
            5.1. Os serviços serão recebidos provisoriamente, de forma sumária, no ato da entrega,
        ...
        <p style="text-align: justify;">
            5.2. Os serviços poderão ser rejeitados, no todo ou em parte, inclusive antes do recebimento
            provisório, quando em desacordo com as especificações constantes no Termo de Referência e na
            proposta, devendo ser substituídos no prazo de 02 (dois) dias, a contar da notificação da
        ...
        <p style="text-align: justify;">
            ...
            contrato. Recebida a Nota Fiscal ou documento de cobrança equivalente, correrá o prazo de trinta
            dias para fins de liquidação, na forma desta seção, prorrogáveis por igual período.
        </p>
        <p style="text-align: justify;">
