...
<body>
    <div>
        ...
        <p style="text-align: justify;">
            ...
            participante deverá efetivar a contratação solicitada em até noventa dias, observado o prazo de
            vigência da ata.
        </p>
        <p style="text-align: justify;">
        ...
        <p style="text-align: justify;">
            4.6. As contratações adicionais não poderão exceder, por órgão ou entidade, a cinquenta por
            cento dos quantitativos dos itens do instrumento convocatório registrados na ata de registro de
            preços para o órgão ou a entidade gerenciadora e para os órgãos ou as entidades participantes.
        </p>
        <p style="text-align: justify;">
        ...
        <p style="text-align: justify;">
            5.13. A existência de preços registrados implicará compromisso da prestação dos serviços nas
            condições estabelecidas, mas não obrigará a Administração a contratar, facultada a realização de
            licitação específica para o serviço pretendido, desde que devidamente justificada, e assegurado
            ao beneficiário do registro preferência de fornecimento ou contratação em igualdade de
            condições.
        </p>
