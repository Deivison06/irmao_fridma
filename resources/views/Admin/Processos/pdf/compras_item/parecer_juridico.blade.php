...
<body>
    ...
    @elseif ($parecer === 'parecer_2')
        ...
        <p style="font-weight: bold; font-size: 14px;">3 – DA ANÁLISE JURÍDICA</p>
        <p style="font-weight: bold; font-size: 14px;">3.1 – DOS PRINCÍPIOS DA ADMINISTRAÇÃO PÚBLICA</p>
        ...
        <p style="text-indent: 30px">
            Conforme se extrai dos autos, o processo trata da aquisição de XXXXXXXXXXXX, cujo
        ...
        <p style="text-indent: 30px">
            ...
            do dispositivo legal mencionado acima, pois trata se de “XXXXXXXXXXXX”, cuja descrição dos
        ...
        <p style="text-indent: 30px">
            Quanto à forma, o processo de escolha do fornecedor será eletrônico, seguindo regras
            definidas no Decreto nº 10.024/2019, que regulamenta a licitação na modalidade Pregão, na forma
            eletrônica, para a aquisição de bens e a contratação de serviços comuns.
        </p>
        ...
        <p style="text-indent: 30px">
            No caso em comento, o Mapa de Riscos desenvolvido pela SECRETARIA MUNICIPAL
            DE XXXXXXXXXXX analisa riscos relacionados à AQUISIÇÃO DE XXXXXXXXX,
    ...
    @elseif($parecer === 'parecer_3')
        ...
        <p style="text-indent: 30px">
            ...
            XXXXXXXXXXXXXXXXXXXXXXXXXXXXX, a fim de atender as demandas da Prefeitura e
        ...
        <p style="text-indent: 30px">
            ...
            devidamente justificada e Mapa Comparativo.
        </p>
        <p style="text-indent: 30px">
            Por fim, os autos foram encaminhados a esta PJM, com a autorização para a autuação do
            certame e a elaboração da minuta de edital e contrato, tendo seguido o processo seu regular trâmite
            com o encaminhamento para a análise desta procuradoria. Em síntese, é o relatório.
        </p>
        <p style="font-weight: bold;">
            2 – ANÁLISE JURÍDICA
        </p>
        <p style="text-indent: 30px">
            ...
            controle prévio de legalidade, conforme estabelece o artigo 53, I e II, da Lei nº 14.133, de 2021.
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; page-break-inside: auto;">
            <tr style="page-break-after: auto;">
                ...
                <td style="width: 50%; text-align: justify; vertical-align: top;">
                    ...
                    processo licitatório seguirá para o órgão de
                    assessoramento jurídico da Administração, que
                    realizará controle prévio de legalidade
                    mediante análise jurídica da contratação. § 1º
                    Na elaboração do parecer jurídico, o órgão de
        ...
        <p style="text-indent: 30px">
            Presume-se que as especificações técnicas contidas no presente processo, inclusive quanto
            ao detalhamento do objeto da contratação, suas características, requisitos e avaliação do preço
            estimado, tenham sido regularmente determinadas pelo setor competente do órgão, com base em
            parâmetros técnicos objetivos, para a melhor consecução do interesse público. O mesmo se
            pressupõe em relação ao exercício da competência discricionária pelo órgão assessorado, cujas
            decisões devem ser motivadas nos autos.
        </p>
        <p style="text-indent: 30px">
            Deve-se salientar que determinadas observações são feitas sem caráter vinculativo, mas em
            prol da segurança da própria autoridade assessorada a quem incumbe, dentro da margem de
            discricionariedade que lhe é conferida pela lei, avaliar e acatar, ou não, tais ponderações. Não
            obstante, as questões relacionadas à legalidade serão apontadas para fins de sua correção. O
            seguimento do processo sem a observância destes apontamentos será de responsabilidade exclusiva
            da Administração.
        </p>
        <p style="text-indent: 30px">
            O artigo 18, incisos I a XI, da Lei n.º 14.133/2021, estabelecem as regras a serem seguidas
            pela administração para realização do procedimento licitatório, cuja redação é a seguinte:
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; page-break-inside: auto;">
            ...
            <tr>
                ...
                <td>
                    ...
                    anteprojeto, projeto básico ou projeto
            ...
            <tr>
                ...
                <td>
                    ...
                    pagamento, das garantias exigidas e ofertadas
            ...
            <tr>
                <td></td>
                <td>
                    IX - a motivação circunstanciada das condições
                    do edital, tais como justificativa de exigências
                    de qualificação técnica, mediante indicação das
                    parcelas de maior relevância técnica ou valor
                    significativo do objeto, e de qualificação
        ...
        <p style="text-indent: 30px">
            Nessa quadra, preleciona o art. 25, c a p u t , da Lei n.º 14.133/2021, que é conteúdo
            obrigatório nos editais licitatórios:
        </p>
        ...
        <p style="text-indent: 30px">
            ...
            se a presença da definição do objeto e das justificativas para a sua contratação, a autorização da
            Autoridade Competente para a instauração do processo de contratação, o estudo técnico preliminar,
            a pesquisa mercadológica, o termo de referência, o decreto de designação do pregoeiro e da equipe
            de apoio, a minuta do Edital.
        </p>
        <p style="text-indent: 30px">
            Desta forma, é possível aferir claramente que os autos do processo encontram-se
            devidamente instruído, atendendo as exigências mínimas legais, ficando evidenciada a solução
            mais adequada para atendimento da necessidade pública.
        </p>
        <p style="text-indent: 30px">
            Do mesmo modo, o critério de julgamento, qual seja, o menor valor por item, atende o que
            determina o art. 6°, inciso XLI, da Lei n.º 14.133/2021, cuja redação é a seguinte:
        </p>
        ...
        <p style="text-indent: 30px">
            Desta forma, é possível aferir que a fase preparatória do certame encontra-se em
            consonância com as exigências mínimas exigidas pela Lei nº 14.133/2021 para fins de contratação
            nesta nova sistemática de licitações públicas.
        </p>

        <p style="font-weight: bold;">
            3 - DA MINUTA DO EDITAL
        </p>
        <p style="text-indent: 30px">
            Conforme já informado ao norte, a elaboração da minuta do edital é um dos elementos que
            devem ser observados na fase interna da licitação pública, tendo aquele sido submetido à análise
            jurídica contendo quatro anexos, quais sejam: o estudo técnico preliminar, a ata de registros de
            preços, o termo de referência e a minuta do contrato.
        </p>
        <p style="text-indent: 30px">
            Diante do apresentado, afere-se que os itens da minuta do Edital estão definidos de forma
            clara e com a devida observância do determinado no artigo 25 da Lei nº 14.133/2021. Diante do
            apresentado a minuta do Edital do processo licitatório estabelece a modalidade de licitação para a
            contratação do objeto como sendo o pregão em sua forma eletrônica, o que se encontra em perfeita
            correção uma vez que o objeto se enquadra na categoria de bens comuns, com padrões de qualidade
            e desempenho passíveis de descrição objetiva e usualmente encontrados no mercado, atendendo o
            disposto nos incisos XIII e XLI, do artigo 6º da Lei nº 14.133/2021.
        </p>
        <p style="font-weight: bold;">
            4 - DA MINUTA DO CONTRATO
        </p>
        <p style="text-indent: 30px">
            Observa-se, por se tratar de fornecimento de objeto de forma contínua, a ser entregue
            parceladamente, de acordo com a necessidade da Contratante, se faz necessário que o acordo
            firmado seja devidamente instrumentalizado em contrato, visto não se enquadrar nas hipóteses de
            exceção quanto a obrigatoriedade do instrumento, conforme disposto no artigo 95 da Lei nº
            14.133/2021.
        </p>
        <p style="text-indent: 30px">
            Tendo a minuta do contrato as seguintes cláusulas: documentos, objeto, obrigações da
            Contratante e Contratada, preço, dotação orçamentária, pagamento, entrega e recebimento do
            objeto, alterações, sanções administrativas, vigência, extinção do contrato, casos omissos,
            publicações e eleição de foro.
        </p>
        <p style="text-indent: 30px">
            Nesta esteira, o artigo 92 e incisos da Lei Geral de Licitações e Contratos Administrativos,
            estabelece as cláusulas que são necessárias nos contratos administrativos, senão vejamos:
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; page-break-inside: auto;">
            ...
            <tr>
                ...
                <td>
                    ...
                    proposta do licitante vencedor ou ao ato que
                    tiver autorizado a contratação direta e à
                    respectiva proposta;
                    <br><br>
                </td>
            </tr>
            ...
            <tr>
                <td></td>
                <td>
                    VII - os prazos de início das etapas de
                    execução, conclusão, entrega, observação e
            ...
            <tr>
                ...
                <td>
                    ...
                    plena execução, quando exigidas, inclusive as
                    que forem oferecidas pelo contratado no caso
                    de antecipação de valores a título de
                    pagamento;
                    <br><br>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    observados os prazos mínimos estabelecidos
                    nesta Lei e nas normas técnicas aplicáveis, e as
            ...
            <tr>
                ...
                <td>
                    ...
                    assumidas, todas as condições exigidas para a
                    habilitação na licitação, ou para a qualificação,
            ...
            <tr>
                ...
                <td>
                    ...
                    bem como em outras normas específicas, para
                    pessoa com deficiência, para reabilitado da
        ...
        <p style="text-indent: 30px">
            Portanto, a minuta do contrato encontra-se com as cláusulas mínimas devidamente
            amparadas na Lei nº 14.133/2021, em especial por se tratar de objeto rotineiro, sem aferição de
            riscos aparentes para a Administração Pública e não se enquadrando como contratação de alto valor.
        </p>
        <p style="text-indent: 30px">
            Outrossim, os requisitos para a qualificação dos licitantes previstos no edital, bem como os
            tópicos destinados às demais fases do processo licitatório, encontram-se devidamente de acordo
            com os parâmetros definidos na Lei 14.133/2021e Decreto Federal 10.024/2019.
        </p>
        <p style="text-indent: 30px">
            Em relação aos requisitos formais da minuta do edital, do termo de referência, da minuta
            do contrato, em que são evidenciadas as obrigações de cada parte de forma clara, e nos demais
            anexos, verifica-se que estes estão de acordo com as exigências legais impostas na Lei nº 14.133/21
            para início e validade do certame. Estando, pois, toda a tramitação aparentando a plena regularidade
            legal sobre seus procedimentos, crê-se na regularidade do procedimento até o presente compasso,
            pelo que se conclui o que segue.
        </p>
        ...
        <p style="text-indent: 30px">
            Diante do exposto, ressalvado o juízo de mérito da Administração, bem como os aspectos
            técnicos, econômicos e financeiros, que escapam à análise dessa Procuradoria Jurídica, diante da
            documentação juntada aos autos, conclui-se pela regularidade do procedimento até o presente
            momento, pelo que opino pela validação jurídica para regular prosseguimento do presente Pregão
            Eletrônico, SEM RESSALVAS.
        </p>
        <p style="text-indent: 30px">
