...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        'font_dir'   => public_path('storage/fonts/'),
        'font_cache' => public_path('storage/fonts/'),

        'fonts' => [
            'montserrat' => [
                'normal' => public_path('storage/fonts/Montserrat-Regular.ttf'),
                'bold'   => public_path('storage/fonts/Montserrat-Bold.ttf'),
                'black'  => public_path('storage/fonts/Montserrat-Black.ttf'),
                'black_italic' => public_path('storage/fonts/Montserrat-BlackItalic.ttf'),
            ],
        ],
